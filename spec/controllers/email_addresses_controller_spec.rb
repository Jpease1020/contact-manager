...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {email: "email@email.com", person_id: 1}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {email: 'justin@gmail.com', person_id: bob.id} }
      let(:new_attributes) { {email: 'email@email.com', person_id: bob.id} }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.email).to eq('email@email.com')
